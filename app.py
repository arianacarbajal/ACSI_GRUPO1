...
pagina = st.sidebar.radio("Ir a", ["Visualización MRI", "Resultados de Segmentación", "Leyendas", "Manual de Usuario",
...
# Página de Resultados de Segmentación
    ...
    if seg_file:
        ...
        if seg_data is not None:
            ...
            slice_idx = st.slider("Selecciona un corte axial para visualizar", 0, seg_data.shape[2] - 1,
                                  seg_data.shape[2] // 2)
